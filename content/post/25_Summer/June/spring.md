...
### ⚙️ **1. Spring Boot 项目中无需显式添加 `@EnableTransactionManagement`**
...
### ⚙️ **1. 默认行为：继承自 `SimpleJpaRepository` 的方法**
